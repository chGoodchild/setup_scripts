...
class ExampleReader : public Everest::ModuleBase {
public:
    ExampleReader() = delete;
    ExampleReader(const ModuleInfo& info, std::unique_ptr<example_readerImplBase> p_example_reader_submodule,
